...
CREATE TABLE `copies` (
  ...
  `copy_id` varchar(4) DEFAULT NULL,
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='Stores labels assignable to a book for user search purposes.';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `transactions` (
  ...
  `copy_id` varchar(4) DEFAULT NULL COMMENT 'fk',
  `user_id` int DEFAULT NULL,
...
-- Dump completed on 2022-08-25 13:53:50
